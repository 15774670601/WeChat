	...
	<body>
			...
			<div class="container-fluid">
                    ...
                    <form action="#" method="get" class="subscribe-form">
               	    	<div class="row form-section">
							...
							<div class="col-md-7 col-sm-7 col-xs-7">
			                      <input name="email" type="text" class="form-control" id="contact_email" placeholder="${demo}" required/>
				  			</div>
				...
				<div class="footer-link">
                    ...
                    <p>More Templates <a href="http://www.cssmoban.com/" target="_blank" title="网页模板">网页模板</a> - Collect from <a href="http://www.cssmoban.com/" title="网页模板" target="_blank">网页模板</a></p>
				</div>
			</div>	
	</body>
